...
public:
	...
	/**
	 * @brief 직선광(Directional Light)의 위치를 얻습니다.
	 * 
	 * @return 직선광(Directional Light)의 위치를 반환합니다.
	 */
	...
	/**
	 * @brief 직선광(Directional Light)의 위치를 설정합니다.
	 * 
	 * @param position 설정할 직선광의 위치입니다.
	 */
