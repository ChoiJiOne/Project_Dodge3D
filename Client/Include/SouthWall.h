 ...
 * @brief 남쪽 벽 오브젝트입니다.
 */
class SouthWall : public IObject
{
public:
	/**
	...
	/**
	 * @brief 남쪽 벽 오브젝트의 메시를 얻습니다.
	 *
	 * @return 남쪽 벽 오브젝트의 메시를 반환합니다.
	 */
	StaticMesh* GetMesh() const { return mesh_; }


	/**
	 * @brief 남쪽 벽 오브젝트의 재질을 얻습니다.
	 *
	 * @return 남쪽 벽 오브젝트의 재질을 반환합니다.
	 */
	Material* GetMaterial() const { return material_; }


	/**
	 * @brief 남쪽 벽 오브젝트의 현재 위치를 얻습니다.
	 *
	 * @return 남쪽 벽 오브젝트의 위치를 반환합니다.
	 */
...
private:
	/**
	 * @brief 남쪽 벽 오브젝트의 정적 메시입니다.
	 */
	StaticMesh* mesh_ = nullptr;


	/**
	 * @brief 남쪽 벽 오브젝트의 재질입니다.
	 */
	Material* material_ = nullptr;


	/**
	 * @brief 남쪽 벽 오브젝트의 현재 위치입니다.
	 */
	Vector3f position_;
